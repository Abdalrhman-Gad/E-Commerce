...
namespace DataAcess.Repos
{
    public class UserRepository : Repository<ApplicationUser>, IUserRepository
    {
        ...
        public UserRepository(ApplicationDbContext db, IConfiguration configuration, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager) : base(db)
        {
            this.db = db;
        ...
        public async Task<UserDTO> Register(RegisterRequestDTO registerRequestDTO)
        {
            ...
            {
                userDTO.ErrorMessages = ["An unexpected error occurred while registering the user."];
            }
        ...
        {
            var existingUser = await db.ApplicationUsers.FindAsync(user.Id);
